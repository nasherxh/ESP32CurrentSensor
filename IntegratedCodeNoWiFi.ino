...
//Create instance of EmonLib EnergyMonitor Class for each phase
  ...
  const float I_AC100_Calibration = 111.11; //********May need tuning (Should be sensor current when have 1V on ADC)**************** Use 30 for 30A-1V, use 111.11 for 18R and 100:50mA
  ...
  //111.11 for 100A:50mA sensor with 18 Ohm resistor
